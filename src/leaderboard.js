...
// UT-style DOM dialog: native prompt() forcibly shows "site.com says", which
// no site can remove — so we draw our own box (also: real <input> keeps IME
// working for Chinese, which canvas key capture can't)
function utPrompt({ title, hint, value = "", maxLength = 8 }) {
  return new Promise((resolve) => {
    ...
    box.style.cssText = "background:#0e0b16;border:3px solid #f2ead8;border-radius:4px;padding:20px 24px;width:min(420px,86vw);font-family:monospace;color:#f2ead8";
    ...
    box.append(titleEl, hintEl, input, row);
    wrap.append(box);
